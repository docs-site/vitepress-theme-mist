...
description:
tdoc:
  detailDate: 2026-09-20 19:28:16.682
...
```vue
<template>
  <MtSegmented v-model="selectedValue" :options="options" />
</template>
...
<template>
  <!-- 禁用整个分段器 -->
  <MtSegmented v-model="disabledValue" :options="options" disabled />
</template>
...
```vue
<template>
  <MtSegmented v-model="selectedIcon" :options="iconOptions" />
</template>
...
```vue
<template>
  <MtSegmented v-model="objectValue" :options="objectOptions" />
</template>
...
```vue
<template>
  <MtSegmented v-model="customValue" :options="customOptions" />
</template>
