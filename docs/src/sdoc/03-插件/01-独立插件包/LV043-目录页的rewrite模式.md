...
description:
tdoc:
  detailDate: 2026-09-20 19:30:55.678
...
![image-20250903184318240](./LV043-目录页的rewrite模式/img/image-20250903184318240.png)

根据前面的目录数据的生成，这个数据是对的，但是将会得到这样的跳转链接：

![image-20250903184641680](./LV043-目录页的rewrite模式/img/image-20250903184641680.png)
...
![image-20250903185544363](./LV043-目录页的rewrite模式/img/image-20250903185544363.png)
...
![image-20250903190658773](./LV043-目录页的rewrite模式/img/image-20250903190658773.png)
