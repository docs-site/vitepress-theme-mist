...
import { useEventListener, useNamespace, useZIndex } from "@mist/composables";
import { closeIcon, circleCloseFilledIcon, infoFilledIcon, successFilledIcon, warningFilledIcon } from "@mist/static";
...
<template>
  ...
  >
    ...
    >
      ...
      <MtIcon v-if="iconComponent" :icon="iconComponent" :class="[ns.e('icon'), typeClass]" />
      <slot>
      ...
      <MtIcon v-if="showClose" :icon="closeIcon" :class="ns.e('closeBtn')" @click.stop="close" />
    </div>
  </Transition>
</template>
