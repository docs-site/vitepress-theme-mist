...
import { useNamespace, useLocale, useDebounce, useEventListener, useZIndex } from "@mist/composables";
import {
  arrowLeftIcon,
  arrowRightIcon,
  closeIcon,
...
import { MtFocusTrap } from "@mist/components/common/FocusTrap";
...
const handleImgError = (e: Event) => {
  loading.value = false;
  (e.target as HTMLImageElement).alt = t("mt.image.error");
};
      ...
      <div ref="wrapper" :tabindex="-1" :class="ns.e('wrapper')" :style="{ zIndex }">
        ...
        >
          ...
          <span :class="[ns.e('btn'), ns.e('close')]" @click="hide">
            <MtIcon :icon="closeIcon" />
          </span>

          <!-- ARROW -->
          <template v-if="!isSingle">
            <span :class="arrowPrevKls" @click="prev">
              <MtIcon :icon="arrowLeftIcon" />
            </span>
            <span :class="arrowNextKls" @click="next">
              <MtIcon :icon="arrowRightIcon" />
            </span>
          </template>
          ...
          <div :class="[ns.e('btn'), ns.e('actions')]">
            <div :class="ns.e('actions__inner')">
              ...
              >
                <MtIcon :icon="zoomOutIcon" @click="handleActions('zoomOut')" />
                <MtIcon :icon="zoomInIcon" @click="handleActions('zoomIn')" />
                <i :class="ns.e('actions__divider')" />
                <MtIcon :icon="mode.icon" @click="toggleMode" />
                <i :class="ns.e('actions__divider')" />
                <MtIcon :icon="refreshLeftIcon" @click="handleActions('anticlockwise')" />
                <MtIcon :icon="refreshRightIcon" @click="handleActions('clockwise')" />
              </slot>
            </div>
          </div>
          <!-- CANVAS -->
