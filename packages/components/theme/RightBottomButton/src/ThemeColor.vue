<!-- 该文件为 @mist/components/themeEnhance/src/ThemeColor.vue 的非扩散版，代码逻辑完全一样 -->
<script setup lang="ts" name="ThemeColor">
import type { ThemeEnhance } from "@mist/config";
import type { ThemeColorOption } from "@mist/components/theme/ThemeEnhance";
import { onMounted, ref, watch } from "vue";
import { useData } from "vitepress";
import { useLocale, useStorage, useThemeColor, varNameList } from "@mist/composables";
...
import {
  ...
  useThemeColorList,
} from "@mist/components/theme/ThemeEnhance";
import { magicIcon } from "@mist/static";
...
<template>
  <MtPopover
    ...
    :title="t('mt.themeEnhance.themeColor.title')"
    role="button"
    :aria-label="t('mt.themeEnhance.themeColor.title')"
  >
    <template #reference>
      <MtIcon :icon="magicIcon" aria-hidden="true" />
    </template>
