...
import { waterIcon } from "@mist/static";
...
<template>
  <BaseTemplate
    ...
    :helper-desc="t('mt.themeEnhance.themeColor.helpDesc')"
    :tips
    :disabled="isMobile"
  >
    <template #title>
      <div class="flx-justify-between flx-1">
        {{ t("mt.themeEnhance.themeColor.title") }}
        <div class="flx-align-center">
          <span class="label">{{ t("mt.themeEnhance.themeColor.speedLabel") }}</span>
