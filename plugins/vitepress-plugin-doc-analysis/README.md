...
安装 `@docs-site/vitepress-plugin-doc-analysis` 插件

```bash
# 推荐使用 pnpm
pnpm i @docs-site/vitepress-plugin-doc-analysis
# or yarn
yarn add @docs-site/vitepress-plugin-doc-analysis
# or npm
npm install @docs-site/vitepress-plugin-doc-analysis
```

添加 `@docs-site/vitepress-plugin-doc-analysis` 插件到 `.vitepress/config.ts`
...
import type { DocAnalysis } from "@docs-site/vitepress-plugin-doc-analysis";
...
```typescript
import type {} from "@docs-site/vitepress-plugin-doc-analysis";
import DocAnalysis from "@docs-site/vitepress-plugin-doc-analysis";
import { defineConfig } from "vitepress";
