# @docs-site/vitepress-plugin-sidebar-resolve

这是一个适用于 `vitepress` 的 Vite 插件，在 `vitepress` 启动后扫描 Markdown 文档来自动生成侧边栏。

>[vitepress-theme-teek/plugins/vitepress-plugin-sidebar-resolve · Kele-Bingtang/vitepress-theme-teek](https://github.com/Kele-Bingtang/vitepress-theme-teek/tree/f93bc0401029ee48b766f051908af1a168f81410/plugins/vitepress-plugin-sidebar-resolve)
...
安装 `@docs-site/vitepress-plugin-sidebar-resolve` 插件

```bash
# 推荐使用 pnpm
pnpm i @docs-site/vitepress-plugin-sidebar-resolve
# or yarn
yarn add @docs-site/vitepress-plugin-sidebar-resolve
# or npm
npm install @docs-site/vitepress-plugin-sidebar-resolve
```

添加 `@docs-site/vitepress-plugin-sidebar-resolve` 插件到 `.vitepress/config.ts`

```typescript
import { defineConfig } from "vitepress";
import Sidebar from "@docs-site/vitepress-plugin-sidebar-resolve";
